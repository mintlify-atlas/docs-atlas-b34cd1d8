...
<ParamField path="MESSAGE_SYNC_LIMIT" type="int" default="200">
...
<ParamField path="E2B_API_KEY" type="string" required>
  API key for E2B code execution sandboxes. Required for the code agent to run Python code and shell commands.
